...
export default function Contact() {
  return (
    <Section id="contacto">
      <SectionTitle
        title="Contacto"
        subtitle="Agenda tu cita o envíanos un mensaje."
      />
      <div className="grid gap-6 md:grid-cols-2">
        <form className="rounded-2xl border border-slate-200 p-6 space-y-4 bg-white">
          ...
          <button
            type="button"
            className="rounded-lg bg-brand-blue text-white px-4 py-2"
          >
            Enviar (demo)
          </button>
          <p className="text-xs text-slate-500">
            * Formulario ilustrativo. Para agendar usa WhatsApp.
          </p>
        </form>
        ...
        <div className="rounded-2xl border border-slate-200 p-6">
          ...
          <p className="text-sm">
            <strong>Tel:</strong> {site.phone}
          </p>
          <p className="text-sm">
            <strong>WhatsApp:</strong>{" "}
            <a className="underline" href={site.whatsapp} target="_blank">
              {site.whatsapp}
            </a>
          </p>
        </div>
