  ...
  return (
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur border-b border-slate-100">
      <Container className="flex items-center justify-between h-16">
        <Link href="/" className="flex items-center gap-3" aria-label={site.shortName}>
          <Image src="/logo.png" alt={site.shortName} width={36} height={36} priority />
          <span className="font-semibold text-brand.dark">{site.shortName}</span>
        </Link>
